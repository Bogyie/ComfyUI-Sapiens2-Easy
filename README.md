...
- **Auto download, auto reuse**
  Models are downloaded into `ComfyUI/models/sapiens2/` and reused on the next run. Download, batch inference, pose detection, and pointmap GLB export progress are shown in ComfyUI when supported.
